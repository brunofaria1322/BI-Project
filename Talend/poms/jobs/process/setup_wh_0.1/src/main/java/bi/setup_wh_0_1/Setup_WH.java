...
public class Setup_WH implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Ndtdd1SSYZ8UATP5lkZfYXABs/NVXpNc40YoxW2eoviFk8UP");
	...
	public void tCreateTable_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tCreateTable_5:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Setup_WH.class.getClassLoader()
					.getResourceAsStream("bi/setup_wh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 48283 characters generated by Talend Open Studio for Data Integration on the
 * May 5, 2022 1:52:39 AM WEST
 ************************************************************************************************/