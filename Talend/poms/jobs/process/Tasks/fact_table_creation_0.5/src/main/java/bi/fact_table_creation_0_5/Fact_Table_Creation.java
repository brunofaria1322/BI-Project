...
package bi.fact_table_creation_0_5;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+KFX2ee2cJFPdDKQaR3BXw68bR23MX0kW23U7FGAEdZDUfiF");
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								flightHashKey.distance = row1.Flight_Distance;
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_person = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.FIRST_MATCH;
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_flight = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.FIRST_MATCH;
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_satisfaction = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.FIRST_MATCH;
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_ticket = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.FIRST_MATCH;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Table_Creation.class.getClassLoader()
					.getResourceAsStream("bi/fact_table_creation_0_5/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 185651 characters generated by Talend Open Studio for Data Integration on the
 * May 5, 2022 11:27:07 PM WEST
 ************************************************************************************************/