 ...
 * @status
 */
public class Update_WH implements TalendJob {
	...
	private final String jobName = "Update_WH";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Update_WH.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				bi.dim_table_creation_1_0.Dim_Table_Creation childJob_tRunJob_1 = new bi.dim_table_creation_1_0.Dim_Table_Creation();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				bi.fact_table_creation_0_3.Fact_Table_Creation childJob_tRunJob_3 = new bi.fact_table_creation_0_3.Fact_Table_Creation();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Update_WH Update_WHClass = new Update_WH();

		int exitCode = Update_WHClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Update_WH.class.getClassLoader()
					.getResourceAsStream("bi/update_wh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Update_WH.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Update_WH");
		}
...
/************************************************************************************************
 * 33976 characters generated by Talend Open Studio for Data Integration on the
 * May 5, 2022 5:06:51 PM WEST
 ************************************************************************************************/