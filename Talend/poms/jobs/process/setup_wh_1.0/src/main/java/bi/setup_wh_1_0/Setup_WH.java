 ...
 * @status
 */
public class Setup_WH implements TalendJob {
	...
	private final String jobName = "Setup_WH";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Setup_WH.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tCreateTable_5_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tCreateTable_5_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:postgresql://" + "ec2-63-35-156-160.eu-west-1.compute.amazonaws.com"
						+ ":" + "5432" + "/" + "dvf35g1up7ihm";

				if (dbProperties_tDBConnection_1 != null && !"".equals(dbProperties_tDBConnection_1.trim())) {
					url_tDBConnection_1 = url_tDBConnection_1 + "?" + dbProperties_tDBConnection_1;
				}
				String dbUser_tDBConnection_1 = "orhwibebqdfiah";

				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:oQVRA4iWHWPWkE4RUBGNJjO+AWDBec1IlMS8HGs7JHjvjZQBRHtKt4fzkI5MJHZgF6w4xzhSFLxEEp0L0hg7ifk+gw1pD577fVHDA9Xxh5GSQQGU+3ZKsE7H5GQ=");
	...
	public void tCreateTable_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tCreateTable_2:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tCreateTable_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tCreateTable_3:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tCreateTable_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tCreateTable_4:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tCreateTable_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				/**
				 * [tCreateTable_5 process_data_begin ] start
				 */

				currentComponent = "tCreateTable_5";

				/**
				 * [tCreateTable_5 process_data_begin ] stop
				 */

				/**
				 * [tCreateTable_5 process_data_end ] start
				 */

				currentComponent = "tCreateTable_5";

				/**
				 * [tCreateTable_5 process_data_end ] stop
				 */
	...
	public static void main(String[] args) {
		final Setup_WH Setup_WHClass = new Setup_WH();

		int exitCode = Setup_WHClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Setup_WH.class.getClassLoader()
					.getResourceAsStream("bi/setup_wh_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Setup_WH.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Setup_WH");
		}
...
/************************************************************************************************
 * 44364 characters generated by Talend Open Studio for Data Integration on the
 * May 5, 2022 2:49:20 PM WEST
 ************************************************************************************************/