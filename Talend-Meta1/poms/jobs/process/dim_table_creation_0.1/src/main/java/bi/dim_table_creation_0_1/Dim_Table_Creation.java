...
package bi.dim_table_creation_0_1;
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:postgresql://" + "10.17.0.232" + ":" + "5432" + "/" + "talend";
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:n9s7FIMoPLHOye+1O9tOQOkqx3DFewcnOLgb5A==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:FipcICdYC+8u7qdwyY419rdLhQ2jbCdECH9ZMQ==");
...
// ###############################
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:1iHtHiYvlOy6FMldhPABLIieq0+XE6kG4VlDMQ==");
...
// ###############################
				...
				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Ct+Tb1m38DxNM80NAFWpbzbj0u8wYuMrlffZrw==");
...
// ###############################
				...
				final String decryptedPassword_tDBOutput_5 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:IrvVp/EqsRp2NfI65iLnXPuQ/qqHihMRybT5Jg==");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Table_Creation.class.getClassLoader()
					.getResourceAsStream("bi/dim_table_creation_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 260155 characters generated by Talend Open Studio for Data Integration on the
 * March 21, 2022 2:55:02 PM WET
 ************************************************************************************************/